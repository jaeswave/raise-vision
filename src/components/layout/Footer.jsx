  ...
  return (
    <footer style={{ background: '#001226' }}>
      ...
      <div className="max-w-7xl mx-auto px-6 pt-14 pb-10">
        ...
        {/* Social media links */}
        <div className="border-t border-white/10 pt-8 pb-6 flex flex-col sm:flex-row items-center justify-between gap-5">
          <p className="text-white/40 text-xs tracking-widest uppercase" style={{ fontFamily: 'Barlow Semi Condensed, sans-serif' }}>
            Follow Us
          </p>
          <div className="flex items-center gap-6">
            <a href="https://instagram.com/raisevisionlogistics" target="_blank" rel="noopener noreferrer"
            ...
            <a href="https://facebook.com/raisevision" target="_blank" rel="noopener noreferrer"
              className="flex items-center gap-2 text-white/45 hover:text-white transition-colors duration-200 text-xs tracking-wider"
              style={{ fontFamily: 'Barlow Semi Condensed, sans-serif' }}>
              <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
