        ...
        <div className="border-t border-white/10 pt-8 pb-6 flex flex-col sm:flex-row items-center justify-between gap-5">
          ...
          <div className="flex items-center gap-6">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-2 text-white/45 hover:text-white transition-colors duration-200 text-base font-bold tracking-wider"
              style={{ fontFamily: "Barlow Semi Condensed, sans-serif" }}
            >
              <svg
                width="16"
            ...
            <a
              href="https://twitter.com/Raisevision_"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-2 text-white/45 hover:text-white transition-colors duration-200 text-base font-bold tracking-wider"
              style={{ fontFamily: "Barlow Semi Condensed, sans-serif" }}
