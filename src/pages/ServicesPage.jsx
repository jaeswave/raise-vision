...
const SERVICES = [
  ...
  },
  {
    ...
    points: [
      ...
      "Vessel tracking",
      "Port of origin liaison",
    ],
    img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR0EMOjHyJGcJZ0DcXwcx5s54pgueMVWKuPeQ&s",
    color: "#003380",
  },
  {
    id: 3,
    icon: "✈️",
    title: "Air Freight Handling",
  ...
  },
  {
    id: 4,
    icon: "🚛",
    title: "Road Transport Coordination",
    ...
    points: [
      "Nationwide haulage coverage",
      "Flatbed & container transport",
      "Real-time tracking",
      "Cargo insurance",
  ...
  },
  {
    id: 7,
    icon: "📄",
    title: "Export Documentation & Advisory",
