...
const sectors = [
  {
    ...
    desc: "Farm inputs, agro-processing equipment, and raw commodity exports including cashew nuts and other agro products.",
    img: "/about-sector-agro.png",
  },
  {
    icon: "⚙️",
    title: "Industrial Machinery",
    desc: "Heavy tractors, harvesters, and farming equipment cleared and transported with precision handling.",
    img: "/about-sector-machinery.png",
  },
  {
    icon: "🏗️",
    title: "Construction Equipment",
    desc: "Excavators, bulldozers, and construction machinery unloaded and delivered to project sites across Nigeria.",
    img: "/about-sector-construction.png",
  },
  {
    icon: "⚡",
    title: "Power & Electrical",
    desc: "Industrial transformers, generators, and power infrastructure components handled with specialist heavy-lift logistics.",
    img: "/about-sector-power.png",
  },
  {
    icon: "🚗",
    title: "Automobile Shipping",
    desc: "Regular and high-end vehicles cleared through RoRo terminals and delivered across Nigeria.",
    img: "/about-sector-autos.png",
  },
  {
    icon: "🏭",
    title: "Warehousing & Haulage",
    desc: "Bonded warehousing, inland haulage coordination, and fleet delivery for high-volume consignments.",
    img: "/about-warehouse.png",
  },
];
...
const companies = [
  {
    ...
    desc: "Customs clearing, freight forwarding, bonded warehousing, and import/export advisory. The foundation of the group.",
    accent: "#2E8B57",
    img: "/about-story-workers.png",
  },
  {
    name: "Power Cargo International Limited",
    role: "Sister Company",
    desc: "Specialised cargo handling for the power and energy sector. Built for high-volume, high-stakes logistics at scale.",
    accent: "#001F4D",
  ...
  },
  {
    name: "Tookevision Nigeria Limited",
    role: "Sister Company",
    desc: "Extended customs and port operations support across multiple Nigerian terminals and logistics channels.",
    accent: "#C9922A",
    img: "/about-group3.png",
  },
];
...
export default function AboutPage() {
  ...
  return (
    <>
      ...
      <section
        className="relative overflow-hidden"
        style={{ background: "#001F4D", minHeight: "520px" }}
      >
        <div className="absolute inset-0">
          <img
            src="/about-hero-port.png"
            alt="Aerial seaport operations"
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(120deg, rgba(0,31,77,0.97) 40%, rgba(0,31,77,0.55))",
            }}
          />
          <svg
            className="absolute inset-0 w-full h-full"
          ...
          >
            {stats.map(({ val, label }) => (
              <div
                key={label}
                className="px-6 py-5"
                style={{ background: "rgba(0,31,77,0.7)" }}
              >
                <div
                  className="font-display font-black text-3xl"
                  style={{ color: "#2E8B57" }}
          ...
          <div className="grid md:grid-cols-2 gap-16 items-start">
            <div>
              ...
              >
                ...
                <p>
                  We provide specialised handling for key sectors critical to
                  Nigeria's economy, including agricultural imports and exports,
                  industrial and manufacturing cargo, and electrical and heavy
                  machinery logistics — all managed with strict compliance to
            ...
            <div className="reveal-scale d2">
              ...
              >
                <img
                  src="/about-story-workers.png"
                  alt="Raisevision port operations team"
                ...
                >
                  <p
                    ...
                    style={{ fontFamily: "Barlow, sans-serif" }}
                  >
                    Our team at Apapa — directing operations with precision
                  </p>
                </div>
              </div>
              {/* Two bottom images */}
              <div className="grid grid-cols-2 gap-4">
                <div className="overflow-hidden" style={{ height: "180px" }}>
                  <img
                    src="/about-trucks.png"
                    alt="Truck haulage fleet"
                    className="w-full h-full object-cover hover:scale-105 transition-transform duration-500"
                    loading="lazy"
                  />
                </div>
                <div
                  ...
                  style={{ background: "#001F4D", height: "180px" }}
                >
                  <p
      ...
      <section className="py-24" style={{ background: "#F4F7F9" }}>
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-14">
            ...
            <p
              className="text-gray-500 mt-4 max-w-2xl mx-auto reveal d2"
              style={{ fontFamily: "Barlow, sans-serif" }}
            >
              From raw agro commodities to heavy industrial machinery — we
              manage high-volume, serious cargo across every sector of Nigeria's
              economy.
            </p>
          </div>

          <div className="grid md:grid-cols-3 gap-6">
            {sectors.map(({ icon, title, desc, img }, i) => (
              <div
                key={i}
                className={`overflow-hidden bg-white reveal d${(i % 3) + 1}`}
                style={{ borderTop: "3px solid #2E8B57" }}
              >
      ...
      <section className="relative overflow-hidden" style={{ height: "340px" }}>
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(to right, rgba(0,31,77,0.92) 45%, rgba(0,31,77,0.3))",
          }}
        >
          <div className="max-w-7xl mx-auto px-6">
            <span
              className="inline-flex items-center gap-3 text-xs tracking-[0.2em] uppercase mb-4"
              style={{
                color: "#2E8B57",
                fontFamily: "Barlow Semi Condensed, sans-serif",
              }}
            ...
            <h3
              className="font-display font-black text-white max-w-lg"
              style={{
            ...
            <p
              ...
              style={{ fontFamily: "Barlow, sans-serif" }}
            >
              Our haulage network moves cleared cargo from port terminals to
              warehouses and final destinations across the country — on time,
              every time.
            </p>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {companies.map(({ name, role, desc, accent, img }, i) => (
              <div
                key={i}
                className={`overflow-hidden reveal d${i + 1}`}
                style={{
                  border: "1px solid #e8ecf0",
                  borderTop: `4px solid ${accent}`,
                }}
